#!/usr/bin/env python3
"""generate_confirm_june2.py — Генерация WAV для автодозвона (дата: второго июня)

Замена "завтра" → "второго июня" в тексте CONFIRM_CALL_TEXT.
Голос: Kore (Gemini TTS), тот же что и в текущем WAV.

Запуск: python3 generate_confirm_june2.py
"""
...
# ───────────────────────────────────────────────────────────────
# ТЕКСТ АВТОДОЗВОНА — "завтра" заменено на "второго июня"
# ───────────────────────────────────────────────────────────────
CONFIRM_CALL_TEXT = (
    "Здравствуйте, это Азовский инкубатор, "
    "ваш заказ доставим второго июня. "
...
OUTPUT_FILE = Path(__file__).parent / "tts_cache" / "confirm_call_june2.wav"
...
# ───────────────────────────────────────────────────────────────
print("=" * 60)
print("🎤 Генерация WAV для автодозвона (второго июня)")
print("=" * 60)
print(f"\n📝 Текст:\n{CONFIRM_CALL_TEXT}\n")
print("⚙️ Параметры:")
print("   Голос: Kore")
